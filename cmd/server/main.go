...
func main() {
	...
	flag.BoolVar(&kiroImportJSON, "kiro-import-json", false, "Import Kiro token from stdin JSON")
	...
	} else if kiroImportJSON {
		cmd.DoKiroImportJSON(cfg, options)
	} else {
